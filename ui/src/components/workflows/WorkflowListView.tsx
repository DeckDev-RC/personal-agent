...
function cloneWorkflowSteps(workflow: Workflow) {
...
function buildTemplateCopyName(template: Workflow, workflows: Workflow[]): string {
...
export default function WorkflowListView() {
  ...
  async function handleCustomizeTemplate(template: Workflow) {
    const created = await createWorkflow({
      name: buildTemplateCopyName(template, workflows),
      description: template.description,
      steps: cloneWorkflowSteps(template),
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        {workflows.length === 0 ? (
          ...
          <div className="space-y-6">
            <WorkflowTemplates
              workflows={workflows}
              runningWorkflowId={runState?.running ? runState.workflowId : undefined}
              onRun={runWorkflow}
            ...
            <section>
              <div className="mb-3">
                <h2 className="text-sm font-medium text-text-primary">Saved workflows</h2>
                <p className="mt-1 text-xs text-text-secondary/70">
                  Run, edit, and schedule the workflows already available in your workspace.
                </p>
              </div>
